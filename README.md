...
### Instalação
 ...
 1. Baixe a modificação no link: https://github.com/opencartbrasil/mapa-vendas-brasil/releases. Localize a versão mais atual e compatível do arquivo "mapa-vendas-brasil.ocmod.zip".
 2. Na administração da loja acesse o menu Extensions->Extension Installer (Extensões->Instalador).
 3. Na página do instalador, clique no botão Upload e selecione o arquivo 'mapa-vendas-brasil.ocmod.zip' (que você baixou deste repositório), e aguarde a conclusão da instalação automática.
